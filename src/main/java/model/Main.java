...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("общую сумму всех товаров без скидки - " );
        System.out.println("сумму скидки для всей корзины - ");
        System.out.println("сумму всех вегетарианских продуктов без скидки - ");
